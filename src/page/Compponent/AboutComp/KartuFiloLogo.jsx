...
const KartuFiloLogo = (props) => {
  return (
    <div className='flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col justify-center items-center font-lato h-[110px] lg:h-[130px] text-center text-sm lg:text-xl text-cust-white2 rounded-[16px] lg:rounded-[22px] bg-cust-orange p-5 max-w-[456px]'>
            {props.desc}
            {/*Buat Deskripsi*/}
        </div>
    </div>
